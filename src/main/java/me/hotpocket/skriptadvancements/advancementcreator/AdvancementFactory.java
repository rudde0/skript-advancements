...
import me.hotpocket.skriptadvancements.advancementcreator.shared.*;
import me.hotpocket.skriptadvancements.advancementcreator.trigger.*;
...
public class AdvancementFactory {
	...
	/**
	 * @param namespace the advancements' ids will be created in this plugin's namespace
	 ...
	 */
	public AdvancementFactory(String namespace, boolean autoActivate, boolean autoReload) {
	...
	public Advancement getSimple(String id, @Nullable Advancement parent, String title, String description, Material icon, String triggerId, Trigger trigger) {
		...
		Advancement advancement = new Advancement(new NamespacedKey(namespace, id), new ItemObject().setItem(icon),
	...
	public Advancement getAllItemsOnce(String id, @Nullable Advancement parent, String title, String description, ItemObject... items) {
		...
		Advancement advancement = new Advancement(new NamespacedKey(namespace, id), items[0], new TextComponent(title), new TextComponent(description));
